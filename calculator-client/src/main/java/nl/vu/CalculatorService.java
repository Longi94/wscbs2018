 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://vu.nl/", wsdlLocation = "http://localhost:8080/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://vu.nl/", "CalculatorService");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://vu.nl/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://vu.nl/", "CalculatorPort"), Calculator.class, features);
    }
