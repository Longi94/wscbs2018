 ...
 * generated in the nl.vu package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://vu.nl/", "add");
    private final static QName _Div_QNAME = new QName("http://vu.nl/", "div");
    private final static QName _Sub_QNAME = new QName("http://vu.nl/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://vu.nl/", "subResponse");
    private final static QName _DivResponse_QNAME = new QName("http://vu.nl/", "divResponse");
    private final static QName _MulResponse_QNAME = new QName("http://vu.nl/", "mulResponse");
    private final static QName _Mul_QNAME = new QName("http://vu.nl/", "mul");
    private final static QName _AddResponse_QNAME = new QName("http://vu.nl/", "addResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: nl.vu
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vu.nl/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vu.nl/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vu.nl/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vu.nl/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vu.nl/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vu.nl/", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vu.nl/", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vu.nl/", name = "addResponse")
